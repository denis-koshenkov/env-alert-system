...
#define CONFIG_LINKED_LIST_MAX_NUM_INSTANCES 24
#define CONFIG_VARIABLE_REQUIREMENT_LIST_MAX_NUM_INSTANCES 7
 ...
 * time. */
#define CONFIG_FAKE_VARIABLE_REQUIREMENT_ALLOCATOR_NUM_REQUIREMENTS 4
