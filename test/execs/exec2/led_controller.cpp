...
{
    LedColor first_color = LED_COLOR_RED;
    LedColor second_color = LED_COLOR_BLUE;
...
TEST_ORDERED(LedController, StaticPatternAlertOngoingLedOffSameColor, 1)
{
    LedColor color = LED_COLOR_BLUE;
...
TEST_ORDERED(LedController, StaticPatternAlertOngoingLedOnSameColor, 1)
{
...
TEST_ORDERED(LedController, AlertPatternStaticOngoing, 1)
{
    ...
    /* Sets led */
    led_controller_set_color_pattern(first_color, LED_PATTERN_STATIC);
    /* Starts the timer and sets led to second color */
    led_controller_set_color_pattern(second_color, LED_PATTERN_ALERT);
    /* Turns off led */
    timer_cb(timer_cb_user_data);
    /* Turns on led */
...
TEST_ORDERED(LedController, AlertPatternStaticOngoingSameColor, 1)
{
    LedColor color = LED_COLOR_GREEN;
