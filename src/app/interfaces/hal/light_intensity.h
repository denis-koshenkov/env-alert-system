#ifndef ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_HAL_LIGHT_INTENSITY_H
#define ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_HAL_LIGHT_INTENSITY_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_HAL_LIGHT_INTENSITY_H */
