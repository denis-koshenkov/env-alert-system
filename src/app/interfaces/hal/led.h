#ifndef ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_HAL_LED_H
#define ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_HAL_LED_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_HAL_LED_H */
