#ifndef ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_PORT_LED_NOTIFICATION_ALLOCATOR_H
#define ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_PORT_LED_NOTIFICATION_ALLOCATOR_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_PORT_LED_NOTIFICATION_ALLOCATOR_H */
