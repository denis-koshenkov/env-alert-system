#ifndef ENV_ALERT_SYSTEM_SRC_HAL_UNIT_TEST_OFF_TARGET_MOCK_TRANSCEIVER_H
#define ENV_ALERT_SYSTEM_SRC_HAL_UNIT_TEST_OFF_TARGET_MOCK_TRANSCEIVER_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_HAL_UNIT_TEST_OFF_TARGET_MOCK_TRANSCEIVER_H */
