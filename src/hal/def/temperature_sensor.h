#ifndef ENV_ALERT_SYSTEM_SRC_HAL_DEF_TEMPERATURE_SENSOR_H
#define ENV_ALERT_SYSTEM_SRC_HAL_DEF_TEMPERATURE_SENSOR_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_HAL_DEF_TEMPERATURE_SENSOR_H */
