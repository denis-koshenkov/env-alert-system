#ifndef ENV_ALERT_SYSTEM_SRC_INTERFACES_DEFS_EAS_LOG_H
#define ENV_ALERT_SYSTEM_SRC_INTERFACES_DEFS_EAS_LOG_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_INTERFACES_DEFS_EAS_LOG_H */
