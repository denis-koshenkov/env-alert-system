#ifndef ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_PORT_EAS_TIMER_H
#define ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_PORT_EAS_TIMER_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_APP_INTERFACES_PORT_EAS_TIMER_H */
