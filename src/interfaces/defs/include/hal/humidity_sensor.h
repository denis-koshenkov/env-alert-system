#ifndef ENV_ALERT_SYSTEM_SRC_INTERFACES_DEFS_INCLUDE_HAL_HUMIDITY_SENSOR_H
#define ENV_ALERT_SYSTEM_SRC_INTERFACES_DEFS_INCLUDE_HAL_HUMIDITY_SENSOR_H
...
#endif /* ENV_ALERT_SYSTEM_SRC_INTERFACES_DEFS_INCLUDE_HAL_HUMIDITY_SENSOR_H */
