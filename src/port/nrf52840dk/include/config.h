...
/* Each alert raiser creates two timer instances - warmup timer and cooldown timer. +7 is for:
 ...
 */
#define CONFIG_EAS_TIMER_MAX_NUM_INSTANCES ((CONFIG_ALERT_RAISER_MAX_NUM_INSTANCES * 2) + 7)
