...
static void submit_sht3x_i2c_complete_cb_to_queue(uint8_t sht3x_i2c_rc)
{
    ...
    if (sht3x_driver_i2c_data.cb) {
        central_event_queue_submit_void_cb_with_params_uint8_user_data_event(sht3x_driver_i2c_data.cb, sht3x_i2c_rc,
                                                                             sht3x_driver_i2c_data.user_data);
    }
}
...
static void twim_handler(nrfx_twim_event_t const *p_event, void *p_context)
{
    ...
    case NRFX_TWIM_EVT_DONE:
        submit_sht3x_i2c_complete_cb_to_queue(SHT3X_I2C_RESULT_CODE_OK);
        break;
    case NRFX_TWIM_EVT_ADDRESS_NACK:
        submit_sht3x_i2c_complete_cb_to_queue(SHT3X_I2C_RESULT_CODE_ADDRESS_NACK);
        break;
    case NRFX_TWIM_EVT_DATA_NACK:
        submit_sht3x_i2c_complete_cb_to_queue(SHT3X_I2C_RESULT_CODE_BUS_ERROR);
        break;
